      ...
      <div :class="route.fullPath === '/' ? 'w-[100%]' : 'lg-w[20%] w-[70%]'">
        <NuxtLink to="/" class="flex flex-grow basis-0 items-center gap-4">
          <img
            ...
            width="60"
            class="transition-all duration-1000 transform hover:rotate-10 origin-right"
          />
          <h2 class="text-[21px] font-mono">
            media <span class="ml-[-10px] text-red-600">Red</span>
          </h2>
        </NuxtLink>
      </div>

      <div
        class="hidden md:flex items-center bg-[#F1F1F2] p-1 rounded-full max-w-[580px] w-full"
      >
        <input
          type="text"
          name=""
          ...
          <div class="relative">
            ...
            >
              ...
              >
                ...
                <span class="pl-2 font-semibold text-sm">Cerrar sesión</span>
              </div>
            </div>
          </div>
        </div>
