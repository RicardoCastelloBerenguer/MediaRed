<template>
  <div>
    ...
    <UploadLayout>
      ...
      <section class="w-full mt-[80px] mb-[40px] bg-white shadow-lg rounded-md py-6 md:px-10 px-4">
        <div>
        ...
        <div class="mt-8 md:flex gap-6">
          ...
          >
            ...
            <span class="mt-4 text-[17px]">Selecciona un video para subirlo</span>
            <span class="mt-1.5 text-[13px] text-gray-500">O arrastra el archivo</span>
            <span class="mt-14 text-[13px] text-gray-500">MP4 o WebM</span>

            <span class="mt-7 bg-[#fe2c55] w-80% font-semibold text-white px-4 py-1.5 rounded-sm hover:bg-[#e3274b]">Selecciona un archivo</span>
          ...
          <div v-else class="md:mx-0 mx-auto mt-4 md:mb-12 mb-16 flex items-center justify-center w-full max-w-[260px]
                      h-[540px] p-3 rounded-2xl cursor-pointer relative">
            <div class="bg-black h-full w-full"/>

              <img src="/images/mobile-case.png" class="absolute z-20 pointer-events-none" alt="mobile-case">

              <img class="absolute right-8 bottom-10 z-20" width="40" src="/images/logo-red.png" alt="">
            ...
            <div class="absolute -bottom-12 flex items-center justify-between z-50 rounded-xl border w-full p-2 border-gray-300">
              <div class="flex items-center truncate">
                ...
                <span class="text-[11px] pl-1 truncate text-ellipsis">{{ fileData.name }}</span>
              </div>
          ...
          <div class="mt-4 mb-6">
            <div class="flex bg-[#F8F8F8] py-4 px-6">
              ...
              <div>
                <span class="block text-semibold text-[15px] mb-1.5">Divide el video y edítalo</span>
                <span class="text-semibold text-[13px] text-gray-400">Puedes rápidamente dividir videos en varios y crear tu propio video con tus partes favoritas </span>
              </div>
              <div class="flex justify-end max-w-[130px] w-full h-full text-center my-auto">
                <button class="px-8 py-1.5 text-white text-[15px] bg-[#F02C56] rounded-sm hover:bg-[#e3274b]">
                  Editar
                </button>
              </div>
            </div>
            ...
            <div class="flex gap-3">
              ...
              <button class="px-10 py-2.5 mt-8 border text-[16px] text-white bg-[#F02C56] hover:bg-[#e3274b] rounded-sm">
                Subir
              </button>
...
<script setup>
  ...
  import UploadError from "~/components/core/UploadError.vue";
